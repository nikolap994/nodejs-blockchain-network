...
bitcoin.makeNewTransaction(120, 'JOHN', 'JASON');

mine(bitcoin);

bitcoin.makeNewTransaction(1120, 'JOHN', 'JASON');
bitcoin.makeNewTransaction(300, 'JASON', 'JOHN');
bitcoin.makeNewTransaction(2700, 'JOHN', 'JASON');
